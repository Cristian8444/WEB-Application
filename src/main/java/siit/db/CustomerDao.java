...
public class CustomerDao {
    ...
    public void updateCustomer(Customer customer) {
        jdbcTemplate.update("UPDATE customers SET name=?, phone=?,email =? WHERE id=?",
...
//                Map.of("name", customer.getName(), ...))
    ...
    public void addNewCustomer (Customer customer) {
       jdbcTemplate.update("INSERT INTO CUSTOMERS (NAME, PHONE, EMAIL, BIRTHDAY)" +
               " VALUES (?,?,?,?)",customer.getName(),customer.getPhone(),customer.getEmail(),customer.getBirthDate());
    }
