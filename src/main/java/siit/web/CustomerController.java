...
public class CustomerController {
    ...
    public ModelAndView displayCustomerEditForm(@PathVariable int id) {
        ...
        mav.addObject("customer", customerService.getOrdersByCustomerId(id));
        return mav;
    }
    ...
    public ModelAndView displayCustomerOrders(@PathVariable("customer_id") int customerId){
        ...
        modelAndView.addObject("customer", customerService.getOrdersByCustomerId(customerId));
    ...
    public ModelAndView addOrder(@RequestParam("customerId") int customerId)
    {
    ...
    public ModelAndView addNewCustomer(){
        ...
        mv.setViewName("customer-add");
        return mv;
    }
    @PostMapping("/add")
    public ModelAndView performAddNewCustomer(@ModelAttribute Customer customer) {
        ModelAndView mav = new ModelAndView();
        try {
    ...
    @GetMapping("{customerId}/delete")
            public ModelAndView performDeleteCustomer(@PathVariable("customerId") int customerId)
    {
        ModelAndView mav = new ModelAndView();
        try {
