...
<body>
	<div class="container">
		<h2>Orders for ${customer.name}&nbsp;&nbsp;
				...
				<form class="form-horizontal" role="form" method="post" action="/customers/orders/add">
            			<div class="form-group">
            				<div class="col-sm-10">
            					<input type="hidden" class="form-control" id="customerId" name="customerId" value="<c:out value="${customer.id}"/>">
            				</div>
